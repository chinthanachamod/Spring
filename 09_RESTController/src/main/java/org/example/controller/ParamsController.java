...
public class ParamsController {
    ...
    //params?id=12
    // http://localhost:8080/09_RESTController_Web_exploded/params?id=12
    @GetMapping(params = {"id"})
    public String test1(@RequestParam("id") String id) {
        return id;
    }

    // http://localhost:8080/09_RESTController_Web_exploded/params?id=12&name=chamod
    @GetMapping(params = {"id", "name"})
    public String test2(@RequestParam("id") String id, @RequestParam("name") String name) {
        return id + " " + name;
    }

    // http://localhost:8080/09_RESTController_Web_exploded/params/new?id=12&name=chamod
